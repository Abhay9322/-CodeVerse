...
//   const API_KEY = 'AIzaSyCesVHrUXApXAsav47acD-ZWKvrFXBu5JE'; // 🔒 Suggest moving this to .env
...
const YouTubeLearning = () => {
  ...
  const DEFAULT_CHANNEL = 'UCeVMnSShP_Iviwkknt83cww'; // CodeWithHarry

  useEffect(() => {
    if (!isSearching) fetchChannelVideos(DEFAULT_CHANNEL);
  }, [isSearching]);
